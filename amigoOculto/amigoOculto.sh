...
# Descricao:
# Este script, com a ajuda do complemento em python na pasta bin (shuffler.py), faz sorteios diversos para brincadeiras de amigo oculto.
# Cada festa e um diretorio dentro da pasta data, e cada usuario e representado por um arquivo CSV, contendo os presentes desejados por ele.
# Apos os sorteios sao gerados textos formatados com os presentes a serem comprados para cada sorteado pelo sorteando.
# Estes textos vao para subdiretorios dentro de results, e devem ser enviados a cada participante do jogo.
